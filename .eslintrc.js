...
module.exports = {
  "rules": {
    ...
    //"react/boolean-prop-naming": 0, // 对于 boolean prop命名格式的限制，默认为 is+name
    ...
    //"react/no-typos": 2, // 检测 propTypes componentWillMount 等拼写错误
    ...
    "react/react-in-jsx-scope": 2, // 对于使用了 JSX，要使用 React 组件，即需要导入 React
